...
public interface OggLibrary extends XiphLibrary {
    ...
    OggLibrary INSTANCE = Native.load("ogg", OggLibrary.class);
    ...
    class ogg_stream_state extends Structure {
        ...
        public Pointer /* unsigned char* */ body_data;
        /** storage elements allocated */
        public NativeLong /* long */ body_storage;
        /** elements stored; fill mark */
        public NativeLong /* long */ body_fill;
        /** elements of fill returned */
        public NativeLong /* long */ body_returned;


        /** The values that will go to the segment table */
        public Pointer /* int* */ lacing_vals;
        /**
         * granulepos values for headers. Not compact
         * this way, but it is simply coupled to the
         * lacing fifo
         */
        public Pointer /* ogg_int64_t* */ granule_vals;
        ...
        public byte[] /* unsigned char */ header = new byte[282];
